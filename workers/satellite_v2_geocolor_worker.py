"""Scheduled-task entrypoint for Satellite v2 GEOColor catalogs."""
...
_WORKER_NAME = "satellite_v2_geocolor"
_DEFAULT_PROFILE = "goes19-geocolor"


def main() -> None:
    parser = argparse.ArgumentParser(description="Refresh Satellite v2 GEOColor catalogs")
