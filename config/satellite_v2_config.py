...
# Presence-driven Full Disk tile warming for Meteosat-9/12. Source prefetch
# remains a separate download-only concern; this selected-product stage reuses
# those sources and publishes only the newest bounded animation tail.
SATELLITE_V2_METEOSAT_TILE_WARM_FRAMES = _env_int(
    "WX_SATELLITE_V2_METEOSAT_TILE_WARM_FRAMES", 2, 1, 12
)
SATELLITE_V2_METEOSAT_TILE_WARM_ZOOMS = tuple(range(1, 7))
SATELLITE_V2_METEOSAT_TILE_WARM_WORKERS = _env_int(
    "WX_SATELLITE_V2_METEOSAT_TILE_WARM_WORKERS", 2, 1, 4
)
SATELLITE_V2_METEOSAT_TILE_WARM_FRESH_WINDOW_SECONDS = _env_int(
    "WX_SATELLITE_V2_METEOSAT_TILE_WARM_FRESH_WINDOW_SECONDS", 450, 30, 3600
)
SATELLITE_V2_METEOSAT_DISK_LONGITUDE_RADIUS_DEGREES = 81.0
SATELLITE_V2_METEOSAT_DISK_LATITUDE_LIMIT_DEGREES = 80.0

# RSS-tuned selected-product warming for Meteosat-11. Channel02/Channel13 keep
# the deeper rapid-worker tail above; other channels and composites get a
# shorter four-frame tail over the operational RSS bounds at z4-z7.
SATELLITE_V2_METEOSAT_RSS_TILE_WARM_JOBS = (("meteosat11", "RSS"),)
SATELLITE_V2_METEOSAT_RSS_TILE_WARM_FRAMES = _env_int(
    "WX_SATELLITE_V2_METEOSAT_RSS_TILE_WARM_FRAMES", 4, 1, 12
)
SATELLITE_V2_METEOSAT_RSS_TILE_WARM_ZOOMS = (4, 5, 6, 7)
SATELLITE_V2_METEOSAT_RSS_TILE_WARM_FRESH_WINDOW_SECONDS = _env_int(
    "WX_SATELLITE_V2_METEOSAT_RSS_TILE_WARM_FRESH_WINDOW_SECONDS", 225, 30, 1800
)
SATELLITE_V2_METEOSAT_RSS_PREFETCH_FRAMES = _env_int(
    "WX_SATELLITE_V2_METEOSAT_RSS_PREFETCH_FRAMES", 2, 1, 6
)
SATELLITE_V2_METEOSAT_RSS_PREFETCH_HOURS = _env_int(
    "WX_SATELLITE_V2_METEOSAT_RSS_PREFETCH_HOURS", 2, 1, 6
)
SATELLITE_V2_METEOSAT_RSS_PREFETCH_KEEP_HOURS = _env_int(
    "WX_SATELLITE_V2_METEOSAT_RSS_PREFETCH_KEEP_HOURS", 3, 2, 12
)
