...
LIVE_RADAR_PRODUCTS = {
    ...
    "L3_N0H": {
        ...
        "field_names": ["hydrometeor_classification", "hc"],
        "palette": "HCA",
        "units": "category",
        "vmin": 0.0,
        "vmax": 10.0,
    ...
    "L3_DPR": {
        ...
        "field_names": ["differential_reflectivity_rate", "precipitation_rate", "differential_precip_rate"],
        "palette": "DPA",
        "units": "in/hr",
        "vmin": 0.0,
        "vmax": 8.0,
    ...
    "L3_NRR": {
        ...
        "field_names": ["total_precipitation", "storm_total_precipitation", "nrr"],
    ...
    "L3_NET": {
        ...
        "product": "NET",
        "label": "L3 Echo Tops",
        "field_names": ["echo_tops", "cloud_top_height", "cloud_top"],
        "palette": "ET",
        "units": "kft",
        "vmin": 0.0,
        "vmax": 70.0,
    ...
    "L3_DVL": {
        ...
        "field_names": ["vertically_integrated_liquid", "vil", "liquid"],
        "palette": "VIL",
        "units": "kg/m²",
        "vmin": 0.0,
        "vmax": 80.0,
