    ...
    try:
        ...
        if hazard == "watches":
            ...
            for feature in features_sorted:
                ...
                zorder_base = 30
                zorder = zorder_base + get_severity_rank(props)

                def _plot_rings(ax, coord_rings, fc, ec, a, lw, z):
                    for ring in coord_rings[:1]:
                        if not ring:
                            continue
                        xs = [p[0] for p in ring]
        ...
        # Draw city, state, county, and country borders above SPC polygons
