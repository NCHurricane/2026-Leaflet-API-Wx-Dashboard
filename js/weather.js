(function () {
    ...
    function _updateTypeSections() {
        ['current', 'alerts', 'radar', 'satellite', 'spc', 'rtma', 'mrms', 'drought', 'wpc'].forEach((type) => {
    ...
    function _detectInitialActiveTabType() {
        const candidates = ['current', 'alerts', 'radar', 'satellite', 'spc', 'rtma', 'mrms', 'drought', 'wpc'];
    ...
    ['current', 'alerts', 'radar', 'satellite', 'spc', 'rtma', 'mrms', 'drought', 'wpc'].forEach((type) => {
        byId(`weather-type-${type}`)?.addEventListener('change', (e) => {
            ...
            const allTypes = ['current', 'alerts', 'radar', 'satellite', 'spc', 'rtma', 'mrms', 'drought', 'wpc'];
            ...
            if (e.target.checked) {
                ...
                _activeTabType = type;
                fitRegion(byId('weather-region')?.value || 'CONUS');
                if (['rtma', 'drought', 'wpc'].includes(type)) {
